...
def double_dqn_train_step(
    ...
    Main difference from standard DQN:

    Standard DQN target:
        max_a Q_target(s_next, a)

    Double DQN target:
        a_star = argmax_a Q_online(s_next, a)
        target = Q_target(s_next, a_star)
...
def main():
    ...
    parser.add_argument("--config", default="configs/double_dqn.yaml")
