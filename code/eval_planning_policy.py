...
def main():
    ...
    parser.add_argument("--urgency-weight", type=float, default=0.25)
    parser.add_argument("--battery-penalty-weight", type=float, default=5.0)

    parser.add_argument(
        "--output",
        default="logs/planning_eval_seed0_1_2.json",
    )
    ...
    policy = PlanningPolicy(
        ...
        battery_penalty_weight=args.battery_penalty_weight,
    )
